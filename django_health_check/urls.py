...
from django_health_check.views import RabbitMQHealthCheckView, DBHealthCheckView, CeleryHealthCheckView, CacheHealthCheckView
...
urlpatterns = [
    ...
    url(r'cache', CacheHealthCheckView.as_view(), name='cache_health_check'),
